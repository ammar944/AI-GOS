...
function mapToResearchResult(
  ...
  return {
    ...
    industryVertical: m(output.industryVertical),
    primaryIcpDescription: m(output.primaryIcpDescription),
    jobTitles: m(output.jobTitles),
    companySize: m(output.companySize),
    geography: m(output.geography),
    productDescription: m(output.productDescription),
    coreDeliverables: m(output.coreDeliverables),
    valueProp: m(output.valueProp),
    pricingInfo: m(output.pricingTiers),
    topCompetitors: m(output.topCompetitors),
    uniqueEdge: m(output.uniqueEdge),
    marketBottlenecks: m(output.marketProblem),
    desiredTransformation: m(output.desiredTransformation),
