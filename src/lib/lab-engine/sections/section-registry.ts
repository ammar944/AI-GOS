...
export const SECTION_REGISTRY = {
  positioningMarketCategory: {
    ...
    allowedTools: ["web_search", "pagespeed"],
  ...
  positioningBuyerICP: {
    ...
    allowedTools: ["web_search", "firecrawl", "reviews"],
    maxExternalLookups: 6,
  ...
  positioningDemandIntent: {
    ...
    allowedTools: ["web_search", "firecrawl", "keyword_ad_probe"],
  ...
  positioningOfferDiagnostic: {
    ...
    allowedTools: ["web_search", "firecrawl", "pagespeed", "reviews", "ga4"],
    maxExternalLookups: 6,
