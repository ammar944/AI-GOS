...
function buildSectionMinimumGuidance(
  ...
  if (definition.sectionOutputSchemaName === "PaidMediaPlanSectionOutput") {
    return [
      ...
      "- Every `competitorReviewInsights.insights[]` item must include a specific claim, number, named feature, or operational signal across the complaint and ad leverage fields.",
