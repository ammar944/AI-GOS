...
export const SECTION_META: Record<string, SectionMeta> = {
  ...
  competitors: { label: 'Competitor Intel', moduleNumber: '02', description: 'Competitive positioning, pricing, and ad activity analysis' },
  icpValidation: { label: 'ICP Validation', moduleNumber: '03', description: 'Ideal customer profile validation and buyer journey mapping' },
