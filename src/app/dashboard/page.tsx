        ...
        <div className="mx-auto max-w-4xl w-full px-8 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-10">
            ...
            >
              ...
              <ArrowRight className="size-4 text-white/20 group-hover:text-[var(--accent-blue)] transition-colors shrink-0" />
            </Link>

            <Link
              href="/research"
              className="group flex items-center gap-4 rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 transition-all hover:border-white/[0.1] hover:bg-white/[0.04] cursor-pointer"
            >
              ...
              <ArrowRight className="size-4 text-white/20 group-hover:text-white/50 transition-colors shrink-0" />
            </Link>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-sm font-medium text-white/50 uppercase tracking-wider font-mono">
                Recent Research
              </h2>
            ...
            {recentSessions.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center rounded-xl border border-white/[0.04] bg-white/[0.01]">
                ...
                <h3 className="text-sm font-medium text-white/40">No research yet</h3>
                ...
                {recentSessions.map((session) => {
                  ...
                  return (
                    <Link
                      ...
                      className="group flex items-center justify-between rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 transition-all hover:border-white/[0.1] hover:bg-white/[0.03] cursor-pointer"
                    >
