  ...
  return (
    <div
      className={cn(
        ...
        'rounded-[var(--radius-lg)] border border-white/10 bg-white/[0.03] hover:border-white/20',
      )}
    >
  ...
  return (
    <a
      ...
      className={cn(
        ...
        'rounded-[var(--radius-md)] border border-white/10 bg-white/[0.03] hover:border-white/20 hover:bg-white/[0.06]',
      )}
