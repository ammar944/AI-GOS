          ...
          <section className="space-y-6">
            <div className="rounded-[28px] border border-white/10 bg-[rgba(8,12,20,0.82)] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur">
              <div className="mb-4 flex items-center justify-between">
                ...
                {isPending ? (
                  <span className="inline-flex items-center gap-2 rounded-full bg-[var(--bg-hover)] px-3 py-1 text-xs text-text-secondary">
        ...
        {rows.map(([label, value]) => (
          <button
            ...
            className={cn(
              ...
              onRowClick ? 'transition-colors hover:bg-[var(--bg-hover)]' : 'cursor-default',
            )}
          >
  ...
  return (
    <span
      className={cn(
        ...
        normalized === 'idle' && 'bg-[var(--bg-hover)] text-text-tertiary',
        normalized !== 'complete' &&
          normalized !== 'error' &&
          normalized !== 'running' &&
          normalized !== 'idle' &&
