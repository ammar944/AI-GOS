...
export type ReasoningContentProps = ComponentProps<typeof CollapsibleContent> & {
  /**
   * Optional markdown string to render via Streamdown. When omitted, children
   * are rendered directly so callers can supply structured JSX (e.g. an
...
export const ReasoningContent = memo(({ className, children, markdown, ...props }: ReasoningContentProps) => (
  <CollapsibleContent
    className={cn(
      "mt-4 text-sm",
