...
export function DocumentHeader({
  ...
  return (
    <header className={cn('mb-[72px]', className)}>
      ...
      <h1 className="mb-[18px] font-serif text-[56px] font-normal leading-[1.05] tracking-[-0.015em] text-[color:var(--text-primary)]">
        {companyName}
      </h1>
      <p className="mb-9 max-w-[60ch] font-serif text-[22px] italic leading-[1.5] text-[color:var(--text-secondary)]">
        {lede}
      </p>
      <div className="flex flex-wrap gap-[18px] border-t border-[color:var(--border-subtle)] pt-[18px] font-mono text-[11px] tracking-[0.04em] text-[color:var(--text-tertiary)]">
