...
function EmptyState({ section, userName, companyName, onStarterClick }: EmptyStateProps) {
  ...
  return (
    ...
    >
      {/* Icon */}
      <div className="w-10 h-10 rounded-xl bg-[var(--accent-blue,#365eff)]/10 border border-[var(--accent-blue,#365eff)]/20 flex items-center justify-center">
        <Sparkles className="w-5 h-5 text-[var(--accent-blue,#365eff)]" />
      </div>
    ...
    >
      ...
      <div
        className={cn(
          ...
          isUser
            ? ''
            : 'bg-[var(--accent-blue,#365eff)]/15 border border-[var(--accent-blue,#365eff)]/25',
        )}
      ...
      >
        {isUser ? (
          ...
          <Sparkles className="w-3 h-3 text-[var(--accent-blue,#365eff)]" />
        )}
      </div>
        ...
        <div className="px-4 py-4 space-y-4">
          ...
          <AnimatePresence>
            {isSubmitted && !isStreaming && (
              ...
              >
                <div className="w-6 h-6 rounded-full shrink-0 flex items-center justify-center bg-[var(--accent-blue,#365eff)]/15 border border-[var(--accent-blue,#365eff)]/25 mt-0.5">
                  <Sparkles className="w-3 h-3 text-[var(--accent-blue,#365eff)]" />
                </div>
