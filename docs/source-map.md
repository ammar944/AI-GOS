...
| `src/lib/ai/` | AI configuration + non-section AI: `providers.ts` (Anthropic/Perplexity clients, MODELS, costs), `prompts/`, `sections/`, `tools/`, `chat-tools/`, `groq-provider.ts`, `spyfu-client.ts`. |
