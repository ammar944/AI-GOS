// skills/landing-page-studio/lib/skill-model.ts
// Skill-local copy of the Ollama model resolver.
// Mirrors src/lib/gtm/skill-model.ts so this skill stays portable per CLAUDE.md
// ("each skill is a self-contained island"). Kept in sync manually until PRD #003
// formalizes a packaging story.
